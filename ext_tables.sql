...
CREATE TABLE tt_content (
    ...
    tx_bootstrap_header_icon_size varchar(48) DEFAULT '' NOT NULL,
    tx_bootstrap_header_icon_alignment varchar(128) DEFAULT '' NOT NULL,
    tx_bootstrap_header_iconset varchar(128) DEFAULT '' NOT NULL,
    tx_bootstrap_header_iconset_alignment varchar(128) DEFAULT '' NOT NULL,
